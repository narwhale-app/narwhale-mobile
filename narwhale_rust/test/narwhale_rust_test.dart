...
void main() {
  test('mnemonic_from_entropy', () {
    // 12-word mnemonic
    expect(
      NarwhaleRust.mnemonic_from_entropy('31313131313131313131313131313131'),
      'couple maze era give basic obtain shadow change couple maze era glide'
    );
    // 24-word mnemonic
    expect(
      NarwhaleRust.mnemonic_from_entropy('3131313131313131313131313131313131313131313131313131313131313131'),
    ...
    expect(() => NarwhaleRust.mnemonic_from_entropy('3131313131313131313131313131313'), throwsException);
    // invalid hex - invalid char
    expect(() => NarwhaleRust.mnemonic_from_entropy('x3131313131313131313131313131313'), throwsException);
    // invalid entropy - not 16 or 32 bytes
    expect(() => NarwhaleRust.mnemonic_from_entropy('313131313131313131313131313131'), throwsException);
  });

  test('mnemonic_to_root_key', () {
    // without a password
    expect(
      NarwhaleRust.mnemonic_to_root_key('couple maze era give basic obtain shadow change couple maze era glide', ''),
    ...
    // with password
    expect(
      NarwhaleRust.mnemonic_to_root_key('couple maze era give basic obtain shadow change couple maze era glide', 'pa\$\$W0rd!'),
    ...
    // invalid mnemonic
    expect(() => NarwhaleRust.mnemonic_to_root_key('couple maze era give basic obtain shadow change couple maze era abandon', ''), throwsException);
    // valid mnemonic with 15 words - should it fail??? Should we support 15 and 18-word mnemonics?
    expect(() => NarwhaleRust.mnemonic_to_root_key('middle banner sunset more refuse icon add guess cruel nice replace clarify salad window way', ''), throwsException);
  });

  test('derive_xpub', () {
    // with h for hardened
    expect(
      NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/84h/0h/0h', 'bitcoin'),
    ...
    // with ' for hardened
    expect(
      NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', "m/84'/1'/0'", 'testnet'),
    ...
    // with tprv as root
    expect(
      NarwhaleRust.derive_xpub('tprv8ZgxMBicQKsPews2wvq5dsfyJHWXiaPkfXoMuLDPCLD8dL7DMG1GxeTxWXBowVs73iRMAbrQFSUouMA8KB9JNPrTwB9Q1idcMeG1T5BbVWQ', 'm/84h/0h/0h', 'bitcoin'),
      '[312e05df/84h/0h/0h]xpub6CXXH6KkmqEavpf5svtvJe1aXWHeBCRVgnQ1qf4ZekwjYGmXAAsxhmJ3rYnq8qfqnWFVcti42yqi6SqNahsTmpizzvxefP7N5GXyhwPZc3H'
    );
    // with non-hardened derivation
    expect(
      NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/0/1/2', 'bitcoin'),
    ...
    expect(
      NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm', 'testnet'),
    ...
    expect(() => NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/1f/2', 'testnet'), throwsException);
    // invalid derivation - trailing slash
    expect(() => NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/1/2/', 'testnet'), throwsException);
    // invalid derivation - missing m/
    expect(() => NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', '1/2', 'testnet'), throwsException);
    // invalid network
    expect(() => NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/1', 'unknown'), throwsException);
    // invalid xprv
    expect(() => NarwhaleRust.derive_xpub('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZ', 'm/1', 'bitcoin'), throwsException);
  });

  test('get_descriptors', () {
    // segwit
    expect(
      NarwhaleRust.get_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/84h/0h/0h', 'segwit', 'bitcoin'),
      {
    ...
    expect(
      NarwhaleRust.get_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/48h/1h/0h', 'nested', 'testnet'),
      {
    ...
    // legacy
    expect(
      NarwhaleRust.get_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/44h/0h/0h', 'legacy', 'bitcoin'),
      {
    ...
    // unknown type
    expect(() => NarwhaleRust.get_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'm/44h/0h/0h', 'raw', 'bitcoin'), throwsException);
  });

  test('get_default_descriptors', () {
    // mainnet
    expect(
      NarwhaleRust.get_default_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'bitcoin'),
      {
        'recv_descriptor': "wpkh([312e05df/84'/0'/0']xpub6CXXH6KkmqEavpf5svtvJe1aXWHeBCRVgnQ1qf4ZekwjYGmXAAsxhmJ3rYnq8qfqnWFVcti42yqi6SqNahsTmpizzvxefP7N5GXyhwPZc3H/0/*)#sdm5z7jr",
        'change_descriptor': "wpkh([312e05df/84'/0'/0']xpub6CXXH6KkmqEavpf5svtvJe1aXWHeBCRVgnQ1qf4ZekwjYGmXAAsxhmJ3rYnq8qfqnWFVcti42yqi6SqNahsTmpizzvxefP7N5GXyhwPZc3H/1/*)#pe74ltzm",
      }
    ...
    // testnet (signet)
    expect(
      NarwhaleRust.get_default_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 'signet'),
      {
  ...
  test('get_account_descriptors', () {
    // mainnet account 2
    expect(
      NarwhaleRust.get_account_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 2, 'segwit', 'bitcoin'),
      {
    ...
    expect(
      NarwhaleRust.get_account_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 3, 'nested', 'signet'),
      {
    ...
    expect(
      NarwhaleRust.get_account_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 2147483647, 'segwit', 'bitcoin'),
      {
    ...
    expect( () => NarwhaleRust.get_account_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', -3, 'nested', 'signet'), throwsException);
    // account larger than 0x80000000-1 ( 2147483647 )
    expect( () => NarwhaleRust.get_account_descriptors('xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm', 2147483648, 'nested', 'signet'), throwsException);
  });

  test('derive_addresses', () {
    // mainnet addresses
    expect(
      NarwhaleRust.derive_addresses(
    ...
    // start > end - empty arr
    expect(
      NarwhaleRust.derive_addresses("sh(wpkh([312e05df/49'/1'/3']tpubDCwzf87ASQN62T68j8SR5LtRp4X2rK1r8U6yKBwvwA9fQmRbMmKx4RMmWcDhD2RTHSHxCXCacbKDiasqTzNGGvaHGkL6VZCKL9GjDnmbqez/1/*))#0x338l5n", 'regtest', 5, 3),
      []
    );
    // invalid index - negative
    expect(()=> NarwhaleRust.derive_addresses("sh(wpkh([312e05df/49'/1'/3']tpubDCwzf87ASQN62T68j8SR5LtRp4X2rK1r8U6yKBwvwA9fQmRbMmKx4RMmWcDhD2RTHSHxCXCacbKDiasqTzNGGvaHGkL6VZCKL9GjDnmbqez/1/*))#0x338l5n", 'regtest', -1, 3), throwsException);
    expect(()=> NarwhaleRust.derive_addresses("sh(wpkh([312e05df/49'/1'/3']tpubDCwzf87ASQN62T68j8SR5LtRp4X2rK1r8U6yKBwvwA9fQmRbMmKx4RMmWcDhD2RTHSHxCXCacbKDiasqTzNGGvaHGkL6VZCKL9GjDnmbqez/1/*))#0x338l5n", 'regtest', 0, 0x80000000), throwsException);
    // check it can derive 1000 addresses
    expect(
      NarwhaleRust.derive_addresses("sh(wpkh([312e05df/49'/1'/3']tpubDCwzf87ASQN62T68j8SR5LtRp4X2rK1r8U6yKBwvwA9fQmRbMmKx4RMmWcDhD2RTHSHxCXCacbKDiasqTzNGGvaHGkL6VZCKL9GjDnmbqez/1/*))#0x338l5n", 'regtest', 0, 1000).length,
      1000
    );
  });
  ...
  test('parse_descriptor', () {
    ...
    // test with /0/*
    expect(
      NarwhaleRust.parse_descriptor("wsh(sortedmulti(1,[312e05df/84h/0h/0h]xpub6CXXH6KkmqEavpf5svtvJe1aXWHeBCRVgnQ1qf4ZekwjYGmXAAsxhmJ3rYnq8qfqnWFVcti42yqi6SqNahsTmpizzvxefP7N5GXyhwPZc3H/0/*,[12345678/49'/1'/3']xpub6EpqBFyJW2qiEmgcYZqwEGCRuQh3y9fY72RWeAG7pNvKJWgnx7mkviWtfsF7VNQhWPx43zzNfkWhoF8RcnP2KKsXbNHrFNdzx8MFy83N5Sq/0/*))", root, 'bitcoin'),
      expected
    );
    // test with /{0,1}/*
    expect(
  ...
  test('parse_transaction', () {
    ...
    var parsed_desc = NarwhaleRust.parse_descriptor('wsh(sortedmulti(1,[b0af58ed/48h/1h/0h/2h]tpubDED6SSLLgFCtDZNQv1BBCoe15uw4ebin4eN3MFNmdLtynBaXNEfVzdkVjqBL2E4kUzCYyYzc7GVNf8vv9Luefpwh2DWXbQVt8ZtCXmes2Zk/0/*,[312e05df/48h/1h/0h]tpubDD5NnAHJkEri3WeR9QP2McFoHeFte3Y9ytQAYKs2TwASMk5XutLLREGB8XvinTvUUU1wD2nvrzEwcXBzsQ1XkFdCKXEpqwLCVf2FHVpGNDb/0/*))', root, 'regtest');
    ...
    var res = NarwhaleRust.parse_transaction(psbt, [wallet], 'regtest');
    expect(res, {
      'inputs': [
        {
  ...
  test('sign_transaction', () {
    ...
    String root = 'xprv9s21ZrQH143K48dWHMyaUE3yzA6KV4MkKytF2unviMieqjN8MtfXSu6WbM29w8UngGtaAWEe65u1SVcPBxoMZLasQXw6MMuZSYWb1QDAbZm';
    String psbt = '';
    String res = NarwhaleRust.sign_transaction(psbt, root);
  ...
  test('greet', () {
    expect(NarwhaleRust.greet('Alice'), 'Hello Alice');
  });
